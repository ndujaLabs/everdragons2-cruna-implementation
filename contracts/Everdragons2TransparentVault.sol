...
import "@cruna/cruna-protocol/contracts/transparentVault/TransparentVault.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";

contract Everdragons2TransparentVault is OwnableUpgradeable, TransparentVault, UUPSUpgradeable {
  ...
  function initialize(address protector) public initializer {
    ...
    __TransparentVault_init(protector, "Everdragons2 Transparent Vault", "E2TV");
